...
func main()  {
	...
	*/
	...
	mapaPersonas := map[string]persona {
		"Juan": persona1,
		"Eduardo": persona2,
	}
	...
	for _, valor := range mapaPersonas {
		//fmt.Println(valor)
		fmt.Print("\nHola mi nombre es:")
		for _, v := range valor.nombre {
			fmt.Print(" ", v)
		}
		
		fmt.Print(" mis apellidos son:")
		for _, v := range valor.apellidos {
			fmt.Print(" ", v)
		}
		fmt.Print(" tengo: ", valor.edad, " años, ")
		fmt.Print("peso: ", valor.peso, "kg, ")
		fmt.Print("mido: ", valor.estatura, "m")
		
		fmt.Print(" y mis hobbies son: ")
